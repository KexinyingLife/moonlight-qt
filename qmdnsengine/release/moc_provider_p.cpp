...
#include "../qmdnsengine/src/src/provider_p.h"
...
namespace {
struct qt_meta_tag_ZN11QMdnsEngine15ProviderPrivateE_t {};
} // unnamed namespace

template <> constexpr inline auto QMdnsEngine::ProviderPrivate::qt_create_metaobjectdata<qt_meta_tag_ZN11QMdnsEngine15ProviderPrivateE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ProviderPrivate, qt_meta_tag_ZN11QMdnsEngine15ProviderPrivateE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QMdnsEngine::ProviderPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine15ProviderPrivateE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine15ProviderPrivateE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11QMdnsEngine15ProviderPrivateE_t>.metaTypes,
    nullptr
} };
...
void *QMdnsEngine::ProviderPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine15ProviderPrivateE_t>.strings))
