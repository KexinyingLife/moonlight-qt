...
namespace {
struct qt_meta_tag_ZN11QMdnsEngine13ProberPrivateE_t {};
} // unnamed namespace

template <> constexpr inline auto QMdnsEngine::ProberPrivate::qt_create_metaobjectdata<qt_meta_tag_ZN11QMdnsEngine13ProberPrivateE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<ProberPrivate, qt_meta_tag_ZN11QMdnsEngine13ProberPrivateE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QMdnsEngine::ProberPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine13ProberPrivateE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine13ProberPrivateE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11QMdnsEngine13ProberPrivateE_t>.metaTypes,
    nullptr
} };
...
void *QMdnsEngine::ProberPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine13ProberPrivateE_t>.strings))
