...
namespace {
struct qt_meta_tag_ZN11QMdnsEngine14AbstractServerE_t {};
} // unnamed namespace

template <> constexpr inline auto QMdnsEngine::AbstractServer::qt_create_metaobjectdata<qt_meta_tag_ZN11QMdnsEngine14AbstractServerE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AbstractServer, qt_meta_tag_ZN11QMdnsEngine14AbstractServerE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject QMdnsEngine::AbstractServer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine14AbstractServerE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine14AbstractServerE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11QMdnsEngine14AbstractServerE_t>.metaTypes,
    nullptr
} };
...
void QMdnsEngine::AbstractServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AbstractServer::*)(const Message & )>(_a, &AbstractServer::messageReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AbstractServer::*)(const QString & )>(_a, &AbstractServer::error, 1))
            return;
    }
}
...
void *QMdnsEngine::AbstractServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11QMdnsEngine14AbstractServerE_t>.strings))
